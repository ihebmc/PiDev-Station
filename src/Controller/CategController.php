...
{
    #[Route('/', name: 'app_categ_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_categ_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_categ_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_categ_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_categ_delete', methods: ['POST'])]
